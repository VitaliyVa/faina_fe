    ...
    let input_type = {
        required: {
            error: {
                ...
                eng: "Це поле обов'язкове для заповнення!",
            },
            check: (value) => {
                if (value.length != 0) {
                    return true
        ...
        comment: {
            error: {
                ...
                eng: 'Це поле обовязкове для заповнення!',
            },
            check: (value) => {
                return validator.isStrongPassword(value, {
                    minLength: 1,
